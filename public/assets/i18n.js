...
const I18N = {
  he: {
    ...
    submit_err: "משהו לא הסתדר - נסו שוב.",
    ...
    day_label: (n) => `יום #${n}`,
    played_today: "כבר שיחקתם היום - לחצו לצפייה בתוצאה",
    scoring: "מחשבים את התוצאה...",
    ...
    swipe_hint: "החליקו ימינה = אנושי, שמאלה = בוט",
    replay_note: "המשחק של היום כבר נספר - שיחוק חוזר לא משנה את התוצאה.",
    archive_empty: "אין ימים קודמים עדיין - בואו מחר.",
  ...
  en: {
    ...
    submit_err: "Something went wrong - try again.",
    ...
    day_label: (n) => `Day #${n}`,
    played_today: "You already played today - see your result",
    ...
    swipe_hint: "Swipe right = HUMAN, left = BOT",
    replay_note: "Today's game already counted - replays don't change your score.",
    archive_empty: "No past days yet - come back tomorrow.",
