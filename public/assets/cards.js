    ...
    return el(`
      <div class="sm-card sm-linkedin">
        <div class="li-row">
          ...
          <div class="li-main">
            <div class="li-head"><span class="redact li-name"></span><span class="li-meta">· 2nd</span><span class="li-meta" style="margin-inline-start:auto">4h</span></div>
    ...
    return el(`
      <div class="sm-card sm-x">
        <div class="x-row">
          <div class="sm-avatar"></div>
          <div class="x-main">
            <div class="x-head"><span class="redact x-name"></span><span class="x-handle">@••••• · 3h</span><span class="x-more">···</span></div>
            ...
            <div class="x-actions">
              ...
              <span class="xa">${X_ICONS.share}</span>
            </div>
          </div>
        </div>
      </div>`);
